      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row">
        <div className="md:w-1/2 order-2  md:order-1 w-full">
          <div className="space-y-6 mt-12 md:mt-32">
            ...
            <p>
              Lorem ipsum dolor sit amet, aut labore repellendus amet explicabo,
              harum dolorem, exercitationem vel nostrum odio ea tempora
              corrupti! Quae delectus neque ducimus fugit tempora?
            </p>
